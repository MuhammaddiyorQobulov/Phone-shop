    ...
    return (
      <>
        <div className="bag">
          ...
          <div className="cards">
            <div className="card">
              <img src={noutbook || product.imgURL} alt="" />
            </div>
            <div className="card">
              <img src={iphone13 || product.imgURL} alt="" />
            </div>
            <div className="card">
              <img src={iphone11 || product.imgURL} alt="" />
            </div>
            <div className="card">
              <img src={iphone111 || product.imgURL} alt="" />
            </div>
          </div>

          <h1 className="money">Bag Total: 24543.32$</h1>
          <button className="btnBag">{icon} View Bag</button>
        </div>
      </>
    );
  }
